...
ACGOD_ENDPOINT_URL = os.getenv("ACGOD_ENDPOINT_URL")
ACGOD_PARTNER_ID = os.getenv("ACGOD_PARTNER_ID")

# Sandbox endpoint: https://agcod-v2-gamma.amazon.com us-east-1
# Production endpoint: https://agcod-v2.amazon.com us-east-1
